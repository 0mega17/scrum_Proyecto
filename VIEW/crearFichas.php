...
<body>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                                    ...
                                    <h2>Section title</h2>
                                    <div class="table-responsive small">
                                        <form id="formularioCrearFicha">
                                            <label for="">Codigo Ficha</label>
                                            <input type="text" class="form-control mb-3" name="codigoFicha" placeholder="Ingrese el codigo de la ficha">
                                            <label>Nombre ficha</label>
                                            <input type="text" class="form-control mb-3" name="nombreFicha" placeholder="Ingrese el nombre Ficha">

                                            <label>Area ficha</label>
                                            <input type="text" class="form-control mb-3" name="areaFicha" placeholder="Ingrese area de la ficha">
    ...
    <script src="../ASSETS/JS/alertaCrearFicha.js"></script>
    <script
        src="https://cdn.jsdelivr.net/npm/chart.js@4.3.2/dist/chart.umd.js"
        integrity="sha384-eI7PSr3L1XLISH8JdDII5YN/njoSsxfbrkCTnJrzXt+ENP5MOVBxD+l6sEG4zoLp"
        crossorigin="anonymous"
